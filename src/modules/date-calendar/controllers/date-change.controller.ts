...
import { DateChangeController as IChange } from "./interface/date-change.controller";

import {SlideDirection, SlidePos, DateWeeks, DateSpecState} from "./type/controll.type";

export class DateChangeController implements IChange {
